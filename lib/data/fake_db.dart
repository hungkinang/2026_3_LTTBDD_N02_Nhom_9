...
class FakeDB {
  ...
  static List<LeaderboardEntry> leaderboard = [
    ...
    LeaderboardEntry(
      ...
      score: 2150,
      quizCount: 30,
      avatarColor: const Color(0xFFFF8A5C),
    ),
    LeaderboardEntry(
      rank: 7,
      name: "Tuấn Đỗ",
      score: 1980,
      quizCount: 28,
      avatarColor: const Color(0xFF88D8B0),
    ),
    LeaderboardEntry(
      rank: 8,
      name: "Mai Ngô",
      score: 1850,
      quizCount: 25,
      avatarColor: const Color(0xFFCDB4DB),
    ),
    LeaderboardEntry(
      rank: 9,
      name: "Khoa Bùi",
      score: 1720,
      quizCount: 22,
      avatarColor: const Color(0xFFFFC8DD),
    ),
    LeaderboardEntry(
      rank: 10,
      name: "Yến Lý",
      score: 1590,
      quizCount: 20,
      avatarColor: const Color(0xFFBDE0FE),
    ),
  ];
}
